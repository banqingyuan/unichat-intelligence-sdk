...
if __name__ == '__main__':
    query_option = QueryOption().set_time_range(start_time='2020-09-01', end_time='2024-12-30').contain('甘木').with_AIDs('22202678-f2443fa238').with_UIDs('22202679', '22202678').with_max_round_number(6)
